                    ...
                    <ul>
                        ...
                        <li><a class="active">{{\App\Helpers\Helper::name_sub_category($id)}}</a></li>
                                ...
                                <div class="float-right filter_cat">
                                    <span>Sort By</span>
                                    <select name="" id="chose_seller" class="form-control">
                                        <option value="4">{{ trans('frontLang.Best_Seller') }}</option>
                                        <option value="4">{{ trans('frontLang.Low_Seller') }}</option>
                                        <option value="5">{{ trans('frontLang.High_Seller') }}</option>
                                    </select>
                                </div>
            </div>
            <!-- ////// -->
...
*/
                                        ...
                                        @foreach(\App\Topic::where("webmaster_id",15)->offset(0)->take($skip)->get() as $stan)
                                            ...
                                            <a href="{{url("products")}}/{{$id}}/type=/{{$stan->id}}">
                                                <span  style="background-color : {{$stan->color_stand}} ;"></span>
                                                <h6>
                                                    @if(App::getLocale()  == 'en')
                                                        {{$stan->title_en}}
                                                    @else
                                ...
                                <div class="this_select_price">
                                    ...
                                    <div class="form-group col-md-12 col-sm-12">
                                        <div id="Range_price" class="range-slider">
                                            <input value="{{$price_sel ? $price_sel  : \App\product::get()[0]->price}}" min="0" max="{{$total_price}}"
                        ...
                        <span class="float-left">
                          <!-- <label>From : </label> -->
                          <input type="number" value="{{$price_sel ? $price_sel : \App\product::get()[0]->price}}" min="0" max="{{$total_price}}" />
                        </span>
                    ...
                    <div class="col-lg-9">
                        ...
                        <section class="sec_products">
                                    ...
                                    <div class="item clearfix">
                                        ...
                                        <div class="txt_info">
                                            <div class="title text-center">
                                                ...
                                                @php
                                                    $priceinf = \App\Price::where("product_id",$product->id)->first();
                                                @endphp
                                                <p>{{@\App\Helpers\Helper::standard_gold_name_to($priceinf->standard_id)}}</p>
                                            ...
                                            <div class="price">
                                                <h4><span>
                                                        @if(@$priceinf->date_end_price > \Carbon\Carbon::now())

                                                         {{@ $priceinf->special_price }}$
                                                    ...
                                                    <del>
                                                        ...
                                                        {{ @$priceinf->special_price ? @$priceinf->price  : "" }}$
                                                        @else
                                            ...
                                            <a  class="add_to_cart" data_id="{{@$product->id}}"data_size="{{@$priceinf->size_id}}" data_stand="{{@$priceinf->standard_id}}"  ><i class="fa fa-shopping-cart fa-lg"></i></a>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
                            </div>
                            <div class="row this_grid"  style="display: none" id="seller_above_5">
                            @foreach(@$c as  $product_bs)
                                @foreach(@$product_bs as  $product)
                                    <div class="col-lg-4 col-md-6 col-sm-6">
                                        <div class="item clearfix">
                                            <div class="img_rings">
                                                <img src="{{url('frontEnd')}}/assets/images/products/1.png" class="img-fluid" alt="">
                            ...
                            <div class="row this_grid" style="display: none" id="seller_above_4">
                                @foreach(@$c4 as  $product_bs)
                                    @foreach(@$product_bs as  $product)
                                    <div class="col-lg-4 col-md-6 col-sm-6">
                                        <div class="item clearfix">
                                            <div class="img_rings">
                            ...
                            <div class="row this_grid" style="display: none" id="seller_above_3">
                                @foreach(@$c3 as  $product_bs)
                                    @foreach(@$product_bs as  $product)
                                    <div class="col-lg-4 col-md-6 col-sm-6">
                                        <div class="item clearfix">
                                            <div class="img_rings">
