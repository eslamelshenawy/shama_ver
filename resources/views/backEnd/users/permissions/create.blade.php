        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="checkbox">
                            <label class="ui-check">
                                {!! Form::checkbox('users_status','1',false, array('id' => 'users_status')) !!}
                                <i class="dark-white"></i><label
                    ...
                    <div class="checkbox">
                            <label class="ui-check">
                                {!! Form::checkbox('orders_status','1',false, array('id' => 'orders_status')) !!}
                                <i class="dark-white"></i><label
                    ...
                    <div class="checkbox">
                            <label class="ui-check">
                                {!! Form::checkbox('filters_status','1',false, array('id' => 'filters_status')) !!}
                                <i class="dark-white"></i><label
                    ...
                    <div class="checkbox">
                            <label class="ui-check">
                                {!! Form::checkbox('promocode_status','1',false, array('id' => 'promocode_status')) !!}
                                <i class="dark-white"></i><label
