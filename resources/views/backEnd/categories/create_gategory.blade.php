    ...
    <div id="content" class="app-content box-shadow-z0" role="main">
        ...
        <div class="padding">
            <div class="box">
                ...
                <div class="box-body">
                    <form method="POST" action="{{url('/store/category')}}" accept-charset="UTF-8" enctype="multipart/form-data">
                        <input name="_token" type="hidden" value="hkdPcdkpLFBcnEINBm1cG9yPzgALyqhtZSm4cHRn">
                        {{csrf_field()}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input  class="form-control"   dir="rtl" name="name_heb" type="text" value="{{ old('name_heb') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input  class="form-control"   dir="ltr" name="name_en" type="text"  value="{{ old('name_en') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select name="section_id" class="form-control c-select" required >
