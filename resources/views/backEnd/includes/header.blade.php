    ...
    <div class="navbar">
        ...
        <ul class="nav navbar-nav pull-right">
            <li class="nav-item p-t p-b">
                <!--<a class="btn btn-sm info marginTop2" href="{{url("admin") }}" target="_blank"-->
                <!--   title="{{ trans('backLang.sitePreview') }}">-->
                <!--    <i class="material-icons">&#xe895;</i> {{ trans('backLang.sitePreview') }}-->
                <!--</a>-->
            </li>
            <?php
            $alerts = count(\App\Helpers\Helper::webmailsAlerts()) + count(\App\Helpers\Helper::eventsAlerts());
            ?>
            @if($alerts >0)
                ...
                <!--                    @foreach(\App\Helpers\Helper::webmailsAlerts() as $webmailsAlert)-->
                ...
                <!--                    </span></li>-->
                <!--                    @endforeach-->
                <!--                    @foreach(\App\Helpers\Helper::eventsAlerts() as $eventsAlert)-->
                <!--                        <li class="list-group-item lt box-shadow-z0 b">-->
                <!--                    <span class="clear block">-->
                            ...
                            <a class="dropdown-item"
                               href="{{ route('webmails') }}"><span>{{ trans('backLang.siteInbox') }}</span>
                                @if( \App\Helpers\Helper::webmailsNewCount() >0)
                                    <span class="label warn m-l-xs">{{ \App\Helpers\Helper::webmailsNewCount() }}</span>
                                @endif
                            </a>
                        @endif
                    @endif
        ...
        <!-- link and dropdown -->
            <ul class="nav navbar-nav">
                <li class="nav-item dropdown">
                    ...
                    @if(App::getLocale()=="he")
                        <a class="btn_langs" href="{{url('en/admin')}}"  style="    float: right;
    display: list-item;
    margin: 1%;
    margin-right: 2%;
    margin-top: 2%;"><i
                    ...
                    @else
                        ...
                        <a class="btn_langs" href="{{url('he/admin')}}" style="    float: right;
    display: list-item;
    margin: 1%;
    margin-right: 2%;
    margin-top: 2%;"><i
