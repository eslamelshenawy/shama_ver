        ...
        <div flex class="hide-scroll">
            <nav class="scroll nav-active-primary">
                ...
                <ul class="nav" ui-nav>
                    ...
                    <li>
                        <a href="{{url('/admin')}}" onclick="location.href='{{url("/admin")}}'">
                  <span class="nav-icon">
                    ...
                    @if(\App\Helpers\Helper::GeneralWebmasterSettings("analytics_status"))
                  ...
                  <span class="nav-caret">
                    ...
                    <i class="material-icons">&#xe1b8;</i>
                        ...
                        @endif
                    @endif
                    @if(\App\Helpers\Helper::GeneralWebmasterSettings("newsletter_status"))
...
<i class="material-icons">&#xe7ef;</i>
                    ...
                    @if(\App\Helpers\Helper::GeneralWebmasterSettings("inbox_status"))
                  ...
                  <span class="nav-icon">
                    <i class="material-icons">&#xe156;</i>
                                    ...
                                    <span class="nav-text">{{ trans('backLang.siteInbox') }}
                                        @if( \App\Helpers\Helper::webmailsNewCount() >0)
                                            <badge class="label warn m-l-xs">{{ \App\Helpers\Helper::webmailsNewCount() }}</badge>
                                        @endif
                                    </span>
                    ...
                    @if(\App\Helpers\Helper::GeneralWebmasterSettings("calendar_status"))
                  ...
                  <span class="nav-icon">
                    ...
                    @if(@Auth::user()->permissionsGroup->users_status)
                            ...
                            <ul class="nav-sub">
                                ...
                                <li class="">
                                    <a href="{{url("users/reg")}}">
                                        <span class="nav-text">{{ trans('backLang.users_admin') }}</span>
                                    </a>
                                </li>

                                <li class="">
                                    <a href="{{url("users/reg/front")}}">
                                        <span class="nav-text">{{ trans('backLang.users') }}</span>
                                    </a>
                                </li>
                            </ul>
                    ...
                    @endif
                    @if(@Auth::user()->permissionsGroup->orders_status)
                        ...
                        <li>
                            ...
                            <span class="nav-icon">
                              <i class="material-icons"></i>
                                ...
                                <span class="nav-text">{{ trans('backLang.orders') }}</span>
                            </a>
                        </li>
                    @endif
                    ...
                    @if(@Auth::user()->permissionsGroup->filters_status)
                        ...
                        <i class="material-icons"></i>
                                ...
                                <span class="nav-text">{{ trans('backLang.filters') }}</span>
                            </a>
                            <ul class="nav-sub">

                                {{--                            <li class="">--}}
                                {{--                                <span class="nav-text">{{ trans('backLang.color') }}</span>--}}
                                {{--                                </a>--}}
                                {{--                            </li>--}}
                                <a href="{{url('14/topics')}}">
                                    <li class="">
                                        <a href="{{url('15/topics')}}">
                                            <span class="nav-text">{{ trans('backLang.filters_standard') }}</span>
                                        </a>
                                    </li>
                  ...
                  <span class="nav-caret">
                    ...
                    <i class="material-icons"></i>
                                ...
                                <span class="nav-text">{{ trans('backLang.hasCategories') }}</span>
                            </a>
                            <ul class="nav-sub">
                                <li class="active">
                                    <a href="{{url('all/cat/products')}}">
                                        <span class="nav-text">  {{ trans('backLang.category_products') }}</span>
                                    </a>
                                </li>
                                <li class="active">
                                    <a href="{{url('all/subcat/products')}}">
                                        <span class="nav-text">  {{ trans('backLang.subcategory_products') }}</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{url('products')}}">
                                ...
                                <li>
                                    <a href="{{url('promo/codes')}}">
                                        <span class="nav-text">{{ trans('promoCode') }}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                    @endif
{{--                    @if(@Auth::user()->permissionsGroup->promocode_status)--}}
                ...
                <?php
                  ...
                  <span class="nav-caret">
                    ...
                    <i class="material-icons">{!! $LiIcon !!}</i>
                                    ...
                                    {{--                                    <li>--}}
                                    {{--                                <a herf="">{{trans('backLang.rocordcompetion')}}</a>--}}
                  ...
                  <span class="nav-icon">
                    ...
                    @if(\App\Helpers\Helper::GeneralWebmasterSettings("banners_status"))
                    ...
                    @if(\App\Helpers\Helper::GeneralWebmasterSettings("settings_status"))
...
<i class="material-icons">&#xe8b8;</i>
                                ...
                                <ul class="nav-sub">
                                    ...
                                    ?>
                                    <li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }}>
                                        <a href="{{ route('filters.setting') }}">
                                            <span class="nav-text">{{ trans('backLang.filtersetting') }}</span>
                                        </a>
                                    </li>


                                    <li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }}>
                                        <a href="{{url('webmaster/banners')}}">
