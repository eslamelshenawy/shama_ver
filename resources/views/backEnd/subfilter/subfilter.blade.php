        ...
        <div class="padding">
            <div class="box">
                <div class="box-header dker">
                    <h3>{{ trans('backLang.Categories_Filters') }}</h3>
                    <small>
                        <a href="{{url('admin')}}">{{ trans('backLang.home') }}</a> /
                        <a>Filters</a> /
                        <a> {{ trans('backLang.Categories_Filters') }}</a>
                    </small>
                </div>
                <div class="row p-a">
                    <div class="col-sm-12">
                        <a class="btn btn-fw primary" href="{{url('sub/filter/sections/create')}}">
                            <i class="material-icons"></i>
                            &nbsp; {{ trans('backLang.create_sub_Categories_Filters') }}</a>
                    </div>
                </div>

                <form method="POST" action="http://127.0.0.1:8000/12/sections/updateAll" accept-charset="UTF-8"><input name="_token" type="hidden" value="hkdPcdkpLFBcnEINBm1cG9yPzgALyqhtZSm4cHRn">
