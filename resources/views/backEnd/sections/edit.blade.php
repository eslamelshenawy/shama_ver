                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    @if(\App\Helpers\Helper::GeneralWebmasterSettings("ar_box_status"))
                                        ...
                                        if ($Sections->seo_url_slug_ar != "" && \App\Helpers\Helper::GeneralWebmasterSettings("links_status")) {
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    @if(\App\Helpers\Helper::GeneralWebmasterSettings("en_box_status"))
                                        ...
                                        if ($Sections->seo_url_slug_en != "" && \App\Helpers\Helper::GeneralWebmasterSettings("links_status")) {
