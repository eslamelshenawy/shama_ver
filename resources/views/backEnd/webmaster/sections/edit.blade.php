                                    ...
                                    @if(\App\Helpers\Helper::GeneralWebmasterSettings("ar_box_status"))
                                        <div class="form-group row">
                                            <label for="file_title_ar"
                                                ...
                                                @if(\App\Helpers\Helper::GeneralWebmasterSettings("ar_box_status") && \App\Helpers\Helper::GeneralWebmasterSettings("en_box_status")){!!  trans('backLang.arabicBox') !!}@endif
                                            </label>
                                            <div class="col-sm-10">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    @if(\App\Helpers\Helper::GeneralWebmasterSettings("ar_box_status"))
                                        ...
                                        if ($WebmasterSections->seo_url_slug_ar != "" && \App\Helpers\Helper::GeneralWebmasterSettings("links_status")) {
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    @if(\App\Helpers\Helper::GeneralWebmasterSettings("en_box_status"))
                                        ...
                                        if ($WebmasterSections->seo_url_slug_en != "" && \App\Helpers\Helper::GeneralWebmasterSettings("links_status")) {
