    ...
    <div class="padding">
        ...
        <div class="box nav-active-border b-info">
            <ul class="nav nav-md">
                ...
                @if(\App\Helpers\Helper::GeneralWebmasterSettings("seo_status"))
                    <li class="nav-item inline">
            ...
            <div class="tab-content clear b-t">
                ...
                icons: {
                  ...
                  <span class="fa fa-calendar"></span>
                        ...
                        @endif
                        @if($WebmasterSection->taxes==0)
                            @if($WebmasterSection->percent==0)
                @if($WebmasterSection->size==0)
                @if($WebmasterSection->partner ==0)
                        ...
                        @if(\App\Helpers\Helper::GeneralWebmasterSettings("ar_box_status"))
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::text('title_il',$Topics->title_il, array('placeholder' => '','class' => 'form-control','id'=>'title_il','required'=>'', 'dir'=>trans('backLang.ltr'))) !!}
                                </div>
                            </div>
                        @endif
                        ...
                        @if($WebmasterSection->status_color_stan==1)

                            <div class="form-group row">
                                <label for="color_stand" class="col-sm-2 form-control-label"> {{ trans('backLang.color') }} </label>
                                <div class="col-sm-10">
                                    <select name="color_stand" id="color_stand" class="form-control c-select">
                                        <option value="">{{ trans('backLang.select_color') }}</option>
                                        <option value="#b76e79" {{$Topics->color_stand == "#b76e79" ? "selected" : "" }}>{{ trans('backLang.Rose_Gold') }}</option>
                                        <option value="#D4AF37" {{$Topics->color_stand == "#D4AF37" ? "selected" : "" }}>{{ trans('backLang.gold') }}</option>
                                        <option value="#c0c0c0" {{$Topics->color_stand == "#c0c0c0" ? "selected" : "" }}>{{ trans('backLang.white_gold') }}</option>
                                        {{--                            <option value="38">{{ trans('backLang.select_color') }}</option>--}}
                                    </select>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="box p-a-xs">
                                                {!! Form::textarea('details_il',$Topics->details_ar, array('ui-jp'=>'summernote','placeholder' => '','class' => 'form-control summernote', 'dir'=>trans('backLang.ltr'),'ui-options'=>'{height: 300}')) !!}
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                @if(\App\Helpers\Helper::GeneralWebmasterSettings("en_box_status"))
                                    <div class="form-group row">
                                        <label for="details_en"
                                               class="col-sm-2 form-control-label">{!!  trans('backLang.bannerDetails') !!}
                                            @if(\App\Helpers\Helper::GeneralWebmasterSettings("en_box_status") && \App\Helpers\Helper::GeneralWebmasterSettings("en_box_status")){!!  trans('backLang.englishBox') !!}@endif
                                        </label>
                                        <div class="col-sm-10">
                                            <div class="box p-a-xs">
                            ...
                            @else
                                @if(\App\Helpers\Helper::GeneralWebmasterSettings("ar_box_status"))
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::textarea('details_il',$Topics->details_il, array('placeholder' => '','class' => 'form-control', 'dir'=>trans('backLang.ltr'),'rows'=>'5')) !!}
                                        </div>
                                    </div>
                                @endif
                                @if(\App\Helpers\Helper::GeneralWebmasterSettings("en_box_status"))
                ...
                @if($WebmasterSection->size==1)
                        <div class="form-group row">
                            <label for="size"
                                   class="col-sm-2 form-control-label">{{ trans('backLang.size') }}
                            </label>
                            <div class="col-sm-10">
                                <input placeholder="" class="form-control" id="size" required="" min="0"
                                       dir="ltr" name="size" type="number" value="{{$Topics->size}}">
                            </div>
                        </div>
                                    @endif
                        ...
                        @endif
                        @if($WebmasterSection->status_color == 0)
                            @if($WebmasterSection->style_gold == 0)
                            @if($WebmasterSection->size == 0)

                                    @if($WebmasterSection->taxes==1)
                                        <div class="form-group row">
                                            <label for="name" class="col-sm-2 form-control-label">{!!  trans('backLang.name_taxes') !!}
                                            </label>
                                            <div class="col-sm-10">
                                                <input placeholder="" class="form-control" id="name" required="" name="name_taxes" type="text" value="{{$Topics->name_taxes}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="name" class="col-sm-2 form-control-label">{!!  trans('backLang.percent') !!}
                                            </label>
                                            <div class="col-sm-10">
                                                <input placeholder="" class="form-control" id="name" required="" name="number_tax" type="number" value="{{$Topics->number_tax}}" step="0.01">
                                            </div>
                                        </div>

                                    @endif
                                        @if($WebmasterSection->percent==1)
                                            <div class="form-group row">
                                                <label for="name" class="col-sm-2 form-control-label">{!!  trans('backLang.percent_org') !!}
                                                </label>
                                                <div class="col-sm-10">
                                                    <input placeholder="" class="form-control" required="" name="percent_org" type="number" value="{{$Topics->percent_org}}" step="0.01">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="name" class="col-sm-2 form-control-label">{!!  trans('backLang.percent_delivery') !!}
                                                </label>
                                                <div class="col-sm-10">
                                                    <input placeholder="" class="form-control" id="name" required="" name="percent_delivery" type="number" value="{{$Topics->percent_delivery}}" step="0.01">
                                                </div>
                                            </div>
                                ...
                                @if($WebmasterSection->taxes==0)
                                            @if($WebmasterSection->percent==0)
                                            @if($WebmasterSection->images_status==0)
                    ...
                    @if($WebmasterSection->icon_status)
                        ...
                        @if(count($WebmasterSection->customFields) >0)
                            ...
                            @foreach($WebmasterSection->customFields as $customField)
                                ...
                                if (\App\Helpers\Helper::GeneralWebmasterSettings("ar_box_status") && \App\Helpers\Helper::GeneralWebmasterSettings("en_box_status")) {
                                    if ($customField->lang_code == "ar") {
                                        $cf_land_identifier = trans('backLang.IsraelBox');
                                    } elseif ($customField->lang_code == "en") {
                                        $cf_land_identifier = trans('backLang.englishBox');
                                    }
                                }
                                if (\App\Helpers\Helper::GeneralWebmasterSettings("ar_box_status") && $customField->lang_code == "ar") {
                                    $cf_land_active = true;
                                    $cf_land_dir = "ltr";
                                }
                                if (\App\Helpers\Helper::GeneralWebmasterSettings("en_box_status") && $customField->lang_code == "en") {
                                    $cf_land_active = true;
                                    $cf_land_dir = "ltr";
                                }
                            ...
                            @if (Session::has('fileST'))
                                @if (Session::get('fileST') == "create")
                                    ...
                                    <div>
                                        ...
                                        @if(\App\Helpers\Helper::GeneralWebmasterSettings("ar_box_status"))
                                            <div class="form-group row">
                                                <label for="file_title_il"
                                                       class="col-sm-2 form-control-label">{!!  trans('backLang.topicName') !!}
                                                    @if(\App\Helpers\Helper::GeneralWebmasterSettings("ar_box_status") && \App\Helpers\Helper::GeneralWebmasterSettings("en_box_status")){!!  trans('backLang.IsraelBox') !!}@endif
                                                </label>
                                                <div class="col-sm-10">
                                                    {!! Form::text('title_il','', array('placeholder' => '','class' => 'form-control','id'=>'file_title_il','required'=>'', 'dir'=>trans('backLang.ltr'))) !!}
                                                </div>
                                            </div>
                                        @endif
                                        @if(\App\Helpers\Helper::GeneralWebmasterSettings("en_box_status"))
                                    ...
                                    <div>
                                        ...
                                        @if(\App\Helpers\Helper::GeneralWebmasterSettings("ar_box_status"))
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    {!! Form::text('title_il',Session::get('AttachFile')->title_il, array('placeholder' => '','class' => 'form-control','id'=>'file_title_il','required'=>'', 'dir'=>trans('backLang.ltr'))) !!}
                                                </div>
                                            </div>
                                        @endif
                                        @if(\App\Helpers\Helper::GeneralWebmasterSettings("en_box_status"))
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="col-sm-4 box p-a-xs">
                                                    <a target="_blank"
                                                       href="{{ URL::to('uploads/topics/'.Session::get('AttachFile')->file) }}"> {!! \App\Helpers\Helper::GetIcon(URL::to('uploads/topics/'),Session::get('AttachFile')->file) !!} {{ Session::get('AttachFile')->file }} </a>
                                                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ URL::to('uploads/topics/'.$file->file) }}"
                                                           target="_blank">
                                                            {!! \App\Helpers\Helper::GetIcon(URL::to('uploads/topics/'),$file->file) !!}
                                                            {{$file->file}}</a>
                                                    </td>
                                                    <td>
                                                        <small>
                                        ...
                                        <div class="col-sm-offset-2 col-sm-8">
                                            ...
                                            @if(\App\Helpers\Helper::GeneralWebmasterSettings("ar_box_status"))
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        {!! Form::text('title_il',Session::get('Map')->title_il, array('placeholder' => '','class' => 'form-control','id'=>'title_il', 'dir'=>trans('backLang.ltr'))) !!}
                                                    </div>
                                                </div>
                                            @endif
                                            @if(\App\Helpers\Helper::GeneralWebmasterSettings("en_box_status"))
                                            ...
                                            @if(\App\Helpers\Helper::GeneralWebmasterSettings("ar_box_status"))
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        {!! Form::textarea('details_il',Session::get('Map')->details_il, array('placeholder' => '','class' => 'form-control','id'=>'details_il','rows'=>'3', 'dir'=>trans('backLang.ltr'))) !!}
                                                    </div>
                                                </div>
                                            @endif
                                            @if(\App\Helpers\Helper::GeneralWebmasterSettings("en_box_status"))
                                                        ...
                                                        <div>
                                                            ...
                                                            @if(\App\Helpers\Helper::GeneralWebmasterSettings("ar_box_status"))
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        {!! Form::text('title_il','', array('placeholder' => '','class' => 'form-control','id'=>'title_il', 'dir'=>trans('backLang.ltr'))) !!}
                                                                    </div>
                                                                </div>
                                                            @endif
                                                            @if(\App\Helpers\Helper::GeneralWebmasterSettings("en_box_status"))
                                                            ...
                                                            @if(\App\Helpers\Helper::GeneralWebmasterSettings("ar_box_status"))
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        {!! Form::textarea('details_il','', array('placeholder' => '','class' => 'form-control','id'=>'details_il','rows'=>'3', 'dir'=>trans('backLang.ltr'))) !!}
                                                                    </div>
                                                                </div>
                                                            @endif
                                                            @if(\App\Helpers\Helper::GeneralWebmasterSettings("en_box_status"))
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                    ...
                                    @if(\App\Helpers\Helper::GeneralWebmasterSettings("ar_box_status"))
                                        <div class="form-group">
                                            <div>
                                                ...
                                                @if(\App\Helpers\Helper::GeneralWebmasterSettings("ar_box_status") && \App\Helpers\Helper::GeneralWebmasterSettings("en_box_status"))
                                                    <small>{!!  trans('backLang.IsraelBox') !!}</small> @endif

                                                {!! Form::text('seo_title_il',$Topics->seo_title_il, array('class' => 'form-control','id'=>'seo_title_il','maxlength'=>'65', 'dir'=>trans('backLang.ltr'))) !!}
                                            </div>
                                        </div>
                                    @endif
                                ...
                                <div class="col-sm-6">
                                    ...
                                    @if(\App\Helpers\Helper::GeneralWebmasterSettings("ar_box_status"))
                                        <?php
                                        $seo_example_title = $Topics->title_il;
                                        $seo_example_desc = \App\Helpers\Helper::GeneralSiteSettings("site_desc_ar");
                                        if ($Topics->seo_title_il != "") {
                                        $seo_example_title = $Topics->seo_title_il;
                                        }
                                        if ($Topics->seo_description_ar != "") {
                                        $seo_example_desc = $Topics->seo_description_ar;
                                        }
                                        if ($Topics->seo_url_slug_ar != "" && \App\Helpers\Helper::GeneralWebmasterSettings("links_status")) {
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    @if(\App\Helpers\Helper::GeneralWebmasterSettings("en_box_status"))
                                        ...
                                        $seo_example_desc = \App\Helpers\Helper::GeneralSiteSettings("site_desc_en");
                                        ...
                                        if ($Topics->seo_url_slug_en != "" && \App\Helpers\Helper::GeneralWebmasterSettings("links_status")) {
...
@section('footerInclude')
                ...
                google.maps.event.addListener(map, 'click', function (e) {
                    ...
                    geocoder.geocode({
                        ...
                        if (status == google.maps.GeocoderStatus.OK) {
                            if (results[0]) {
                                @if(\App\Helpers\Helper::GeneralWebmasterSettings("ar_box_status"))
                                $("#details_il").val(results[0].formatted_address);
                                @endif
                                @if(\App\Helpers\Helper::GeneralWebmasterSettings("en_box_status"))
    ...
    <script>
        ...
        @if(\App\Helpers\Helper::GeneralWebmasterSettings("ar_box_status"))
        $("#seo_title_il").on('keyup change', function () {
            if ($(this).val() != "") {
                $("#title_in_engines_ar").text($(this).val());
            } else {
                $("#title_in_engines_ar").text("<?php echo $Topics->title_il; ?>");
            }
        });
        $("#seo_description_ar").on('keyup change', function () {
            if ($(this).val() != "") {
                ...
                $("#desc_in_engines_ar").text("<?php echo \App\Helpers\Helper::GeneralSiteSettings("site_desc_ar"); ?>");
            }
        });
        ...
        $("#seo_description_en").on('keyup change', function () {
            if ($(this).val() != "") {
                ...
                $("#desc_in_engines_en").text("<?php echo \App\Helpers\Helper::GeneralSiteSettings("site_desc_en"); ?>");
            }
        });
