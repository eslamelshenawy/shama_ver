                ...
                @if(\App\Helpers\Helper::GeneralWebmasterSettings("ar_box_status"))
                    <div class="form-group row">
                        <label for="title_il"
                            ...
                            @if(\App\Helpers\Helper::GeneralWebmasterSettings("ar_box_status") && \App\Helpers\Helper::GeneralWebmasterSettings("en_box_status")){!!  trans('backLang.hebrew') !!}@endif
                        </label>
                        <div class="col-sm-10">
                            {!! Form::text('title_il','', array('placeholder' => '','class' => 'form-control','id'=>'title_il','required'=>'', 'dir'=>trans('backLang.ltr'))) !!}
                        </div>
                    </div>
                @endif
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select name="color_stand" id="color_stand" class="form-control c-select">
                            ...
                            <option value="#b76e79">{{ trans('backLang.Rose_Gold') }}</option>
                            <option value="#D4AF37">{{ trans('backLang.gold') }}</option>
                            <option value="#c0c0c0">{{ trans('backLang.white_gold') }}</option>
            ...
            @if($WebmasterSection->longtext_status)
                    ...
                    @else
                        @if(\App\Helpers\Helper::GeneralWebmasterSettings("ar_box_status"))
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::textarea('details_il','', array('placeholder' => '','class' => 'form-control', 'dir'=>trans('backLang.rtl'),'rows'=>'5')) !!}
                                </div>
                            </div>
                        @endif
                        @if(\App\Helpers\Helper::GeneralWebmasterSettings("en_box_status"))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input placeholder="" class="form-control" id="size" required="" min="0"
                                       dir="ltr" name="size" type="number" value="">
                            </div>
                        </div>
                @endif
                ...
                @if($WebmasterSection->size == 0)
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input placeholder="" class="form-control" id="name" required="" name="name_taxes" type="text" value="{!!  old('name_taxes') !!}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input placeholder="" class="form-control" id="name" required="" name="number_tax" type="number" value="{!!  old('number_tax') !!}" step="0.01">
                                </div>
                            </div>t
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input placeholder="" class="form-control" required="" name="percent_org" type="number" value="{!!  old('percent_org') !!}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input placeholder="" class="form-control" id="name" required="" name="percent_delivery" type="number" value="{!!  old('percent_delivery') !!}" step="0.01">
                                </div>
                            </div>
