...
{{--            {{dd($WebmasterSection)}}--}}
            @if($WebmasterSection->status_type == 0)
            @if($WebmasterSection->status_create == 0)
            ...
            @if($Topics->total() > 0)
                ...
                <div class="table-responsive">
                    <table class="table table-striped  b-t">
                        ...
                        <tr>
                            ...
                            <th class="text-center" style="width:80px;">{{ trans('backLang.color') }}</th>
                                                        @endif
                ...
                @if($WebmasterSection->status_color_stan==1)
                                  ...
                                  <td class="text-center">
                                        <small>
                                            @if($Topic->color_stand == "#b76e79")
                                            {{ trans('backLang.Rose_Gold') }}
                                            @elseif($Topic->color_stand == "#D4AF37")
                                            {{ trans('backLang.gold') }}
                                            @elseif($Topic->color_stand == "#c0c0c0")
                                             {{ trans('backLang.white_gold') }}
                                            @endif
                                        </small>
                                    </td>
                                @endif
                                ...
                                <td class="text-center">
                                    ...
                                    @endif
                                     @if($WebmasterSection->status_delete == 0)
