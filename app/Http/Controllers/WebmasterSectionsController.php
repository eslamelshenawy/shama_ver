...
class WebmasterSectionsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //URL Slugs
        $slugs = \App\Helpers\Helper::URLSlug($request->name, $request->name, "section", 0);
    ...
    public function seo(Request $request, $id)
    {
        ...
        if ($WebmasterSection) {
            ...
            //URL Slugs
            $slugs = \App\Helpers\Helper::URLSlug($request->seo_url_slug_ar, $request->seo_url_slug_en, "section", $id);
            $WebmasterSection->seo_url_slug_ar = $slugs['slug_ar'];
            $WebmasterSection->seo_url_slug_en = $slugs['slug_en'];
