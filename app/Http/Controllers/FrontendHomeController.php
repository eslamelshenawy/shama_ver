...
// Home Partners
        ...
        if (($WebmasterSection)) {
            ...
            if (($AllSections)) {
                foreach ($AllSections as $AllSection) {
                    ...
                    $category_and_topics_count[$AllSection->id] = ($Topics);
                }
            }
    ...
    public function topicByLang($lang = "", $section = 0, $id = 0)
    {
        ...
        if (($WebmasterSection)) {
            ...
            if (($Topic) && ($Topic->expire_date == '' || ($Topic->expire_date != '' && $Topic->expire_date >= date("Y-m-d")))) {
                // update visits
